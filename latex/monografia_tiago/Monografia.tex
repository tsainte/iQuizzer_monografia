...
%\usepackage[latin1]{inputenc}
% Permite utilização de referencias cruzadas
...
\newcommand{\titulo}{Estudo comparativo das plataformas Android e iOS para aplicações RESTful}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAPÍTULO 2: Server-Side
\include{chp2/fundamentacao}
%%%% CAPÍTULO 3: Aplicação
\include{chp3/aplicacao}
%%%%%%%%%%®%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAPÍTULO 4: Rails
\include{chp4/rails}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAPÍTULO 5: iOS
\include{chp5/comparativo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAPÍTULO 7: Resultados
\include{chp6/resultados}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAPÍTULO 8: Conclusões
\include{chp7/conclusoes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% AP\^{E}NDICE
%\appendix
%\begin{appendices}
