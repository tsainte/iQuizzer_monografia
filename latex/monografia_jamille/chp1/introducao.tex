...
Neste sentido, o desenvolvimento de um \emph{framework} para auxiliar no diagnóstico de discos rígidos é proposto neste trabalho. Ele é baseado em comandos \ac{ATA}, \ac{SCSI} e \ac{SMART}, voltado para o desenvolvimento de testes rápidos, que levam de 5 a 10 minutos para diagnosticar um dispositivo, e para a execução em \emph{desktops} e \emph{laptops} em uso,  e pensado para sistemas Linux. A partir deste \emph{framework}, uma camada de aplicação com os algoritmos de testes mais importantes e mais frequentes nas ferramentas de diagnóstico do mercado é implementada, focando em algoritmos para testes rápidos. Esta camada foi  portada para uma versão inicializável do Linux, chamada neste trabalho de \emph{Bootable}.
