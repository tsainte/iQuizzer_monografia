...
\section{Visão geral}
        Com o intuito de demonstrar a arquitetura em estudo definida nos capítulos 1 e 2, foi idealizado um aplicativo com módulos Web e Mobile de forma a demonstrar todas as tecnologias citadas.
        ...
        Conforme citado no capitulo x,os aplicativos móveis mais requisitados nos mercados de aplicativos móveis são de entretenimento e de jogos. Desse modo, idealizamos um sistema, composto de dois grandes módulos:
\begin{itemize}
